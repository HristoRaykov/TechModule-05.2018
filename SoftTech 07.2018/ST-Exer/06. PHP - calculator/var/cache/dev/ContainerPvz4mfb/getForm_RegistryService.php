...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('CalculatorBundle\\Form\\CalculatorType' => function () {
    return ${($_ = isset($this->services['CalculatorBundle\Form\CalculatorType']) ? $this->services['CalculatorBundle\Form\CalculatorType'] : $this->services['CalculatorBundle\Form\CalculatorType'] = new \CalculatorBundle\Form\CalculatorType()) && false ?: '_'};
